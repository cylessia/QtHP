...
abstract class QSqlQuery extends QAbstractObject {
    ...
    public function __construct($query = '', $database = null){
        ...
        if(is_string($query) && $query != '' && $database instanceof QSqlDatabase){
    ...
    public function prepare($query){
        ...
        if($this->_query !== null){
            throw new QSqlQueryQueryException('Query is already set !');
        }
     ...
     * @return QSqlQuery
     */
    abstract public function bindDate($placeHolder, $value, $format);
...
class QSqlQueryException extends QAbstractObjectException {
    private $_sqlError;
    public function __construct($message, $sqlError){
