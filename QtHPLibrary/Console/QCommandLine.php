...
class QCommandLine extends QAbstractObject {
    ...
    public function __construct($execPath){
        ...
        if($execPath instanceof QCommandLine){
            ...
            $args = func_get_args();
            throw new QCommandLineSignatureException('Call to undefined function DCommandLine::DCommandLine(' . array_map('dpsGetType', $args) . ')');
        }
    }
...
//    }
    ...
    public static function checkLoaded($extension){
        if(is_array($extension)){
            ...
            throw new QCommandLineSignatureException('Call to undefined function DCommandLine::isLoaded(' . implode(',', array_map('dpsGetType', func_get_args())) . ')');
        }
    }
